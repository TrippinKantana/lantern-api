...
export const createJobSchema = z.object({
  ...
  aboutLantern: optionalString,
  opportunity: optionalString,
  responsibilities: optionalString,
  requirements: optionalString,
  preferredQualifications: optionalString,
  whatYoullGain: optionalString,
  probationEmployment: optionalString,
  whyJoinLantern: optionalString,
